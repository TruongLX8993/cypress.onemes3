...
describe("Tiếp nhận", () => {
    ...
    //     cy.get('li.select2-search').find('input.select2-search__field').type('LINH TEST').wait(5500);
    //     cy.get('#select2-drpSelectTimKiem-results').find('tr:first').click();
    //     cy.get('.confirm').click();
    //
    //     cy.get('.select2-selection__choice__remove').click();
    //     cy.get('#drpSelectTimKiem').parent().find('span.selection span.select2-selection ul.select2-selection__rendered').click();
    //     cy.get('li.select2-search').find('input.select2-search__field').type('MAI').wait(5500);
    //     cy.get('#select2-drpSelectTimKiem-results').find('tr:first').click();
    //
    //     cy.get('#txtDiaChiSoNha').type("Số nhà test");
