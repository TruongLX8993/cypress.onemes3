...
describe("Điều trị nội trú", () => {
    ...
    it('Check khi kê VTYT/thuốc', function () {
        ...
        cy.get('#cboThuoc').parent().find('span.selection span.select2-selection').click();
        cy.get('span.select2-search').find('input.select2-search__field').type('c').wait(3000);
        cy.get('span.select2-results > ul.select2-results__options').find('li').eq(2).click({force:true});
        ...
        cy.get('span.select2-search').find('input.select2-search__field').type('3').wait(3000);
        cy.get('span.select2-results > ul.select2-results__options').find('li').eq(3).click({force:true});
        ...
        // cy.get('.confirm').click();
        cy.get('#cboThuoc').parent().find('span.selection span.select2-selection').focus();
        cy.get('span.select2-search').find('input.select2-search__field').type('b').wait(3000);
        cy.get('span.select2-results > ul.select2-results__options').find('li').eq(2).click({force:true});
        cy.get('#txtSl').type('4');
        cy.get('#txtSlN').type('2');
        cy.get('#btnChon').click();
